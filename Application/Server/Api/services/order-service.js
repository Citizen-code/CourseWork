const {engine, car, order, list_services, service, status_order, consumable_part, list_consumable_parts, service_price, employee, photo, client } = require('../models/init-models')
    ...
    async findAll(option, include = undefined) {
        if (include == "true") {
            option.include = [
                ...
                { model: client, as: 'client', include:{model:car, as:'car', include:[{model:engine, as:'engine'},{model:photo, as:'photo'} ]}}
            ]
        }
